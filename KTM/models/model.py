...
class KTM(nn.Module):
    ...
    def optimize_params_dict(self):
        ...
        params.append({'params': self.kbmt.parameters()})
    ...
    def forward(self, batch):
        ...
        # get the mask matrix of theme and sentiment for maks-self-attention, (batch_size, 1, max_length, max_length)
        ...
        theme_token_output, senti_token_output = self.kbmt(embedding, seq_len, theme_matrix, senti_matrix) 
